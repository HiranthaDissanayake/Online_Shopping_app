...
class BlousesPage extends StatefulWidget {
  const BlousesPage({super.key});

  @override
  State<BlousesPage> createState() => _BlousesPageState();
}

class _BlousesPageState extends State<BlousesPage> {
  @override
              ...
              builder: (context, snapshot) {
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var blouse = snapshot.data![index];

                    return GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Item(item: blouse,) ));
                      },
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            Expanded(
                              child: blouse['imageUrl'] != null
                                  ? ClipRRect(
                                    borderRadius: BorderRadius.only(
                                        topLeft: Radius.circular(10),
                                        topRight: Radius.circular(10)),
                                    child: CachedNetworkImage(
                                        imageUrl: blouse['imageUrl'],
                                        fit: BoxFit.cover,
                                        width: 200,
                                        height: 30,
